...
import BasicTabsProduct from "../../components/TabsProducts";
...
<div className="header-top-hide product-filter"
 onClick={openClose}
>
  {/* <ul> */}
  <BsFilter/> <p className="text-center	text-base font-medium	" onClick={handleFilterClick}>
      Filter
    </p>
    {/* <li>
    </li>
    ...
    <div className="header-bottom"
      ...
      <h2>Products</h2>
      <span>All categories {'>'} 54042 results</span>
    </div>
      </div>
    <div className="container-projects " 
     onClick={openClose}>
      ...
      <a href="#" className="flex reset-search">
        <AiOutlineFieldTime className="mt-0.5"/>
